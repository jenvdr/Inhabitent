...
if ( ! function_exists( 'inhabitent_setup' ) ) :
	...
	function inhabitent_setup() {
		 ...
		 * If you're building a theme based on inhabitent, use a find and replace
		 * to change 'inhabitent' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'inhabitent', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'inhabitent' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'inhabitent_custom_background_args', array(
